  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-sage text-foreground font-semibold hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        "hero-outline": "border-2 border-foreground/20 bg-card text-foreground font-semibold hover:bg-muted hover:border-foreground/40",
        cta: "bg-sage text-foreground font-semibold px-8 hover:shadow-glow hover:scale-[1.02]",
        soft: "bg-card text-foreground border border-border hover:bg-muted hover:border-primary/30",
        nav: "bg-sage text-foreground font-medium hover:shadow-soft",
      },
      size: {
